...
u32 exits_per_reason[70]; // atomic_t exits_per_reason[70];
...
u64 total_time_spent_per_reason[70]; // atomic_long_t total_time_spent_per_reason[70];
EXPORT_SYMBOL(total_time_spent_per_reason);
